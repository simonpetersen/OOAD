...
public class DBInitialiser {
	...
	public void createDB() throws DALException {
		...
		Connector.doUpdate("CREATE TABLE answerOptions (optionID INTEGER PRIMARY KEY, dilemmaID INTEGER, answerOption VARCHAR(40), numberOfAnswers INTEGER, FOREIGN KEY(dilemmaID) REFERENCES dilemma(dilemmaID))");
